...
def evaluate(**kwargs):
    ...
    for save_dir in [rgb_save_dir, diffuse_rgb_save_dir, diffuse_albedo_save_dir, norm_save_dir]:
    ...
    for data_index, (indices, model_input, ground_truth) in enumerate(eval_dataloader):
        ...
        rgb_eval = rgb_eval.transpose(1, 2, 0)
        if kwargs['save_exr']:
            imageio.imwrite('{0}/sg_rgb_{1}.exr'.format(rgb_save_dir, out_img_name), rgb_eval)
        ...
        if kwargs['save_exr']:
            imageio.imwrite('{0}/normal_{1}.exr'.format(norm_save_dir, out_img_name), normal)
