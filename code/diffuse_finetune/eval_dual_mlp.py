...
def evaluate(**kwargs):
    ...
    # evaldir = os.path.join('../cvpr23/exps', task, flag, kwargs['expname'], os.path.basename(kwargs['data_split_dir']))
    ...
    for data_index, (indices, model_input, ground_truth) in enumerate(eval_dataloader):
        ...
        # edited_pixel_coords = model.get_edited_pixel_under_current_viewdir(model_input, edited_3d_points, threshold=kwargs['threshold'])
        ...
        for s in split:
            ...
            out = model.forward_dual_mlp(s, edited_pixel_coords)
