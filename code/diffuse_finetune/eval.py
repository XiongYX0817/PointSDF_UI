...
def evaluate(**kwargs):
    ...
    ckpt_path = os.path.join('/data1/sr/code/PhySG/code/diffuse_finetune/models/regularization_loss_edit_diffuse_rgb_bodian/model_params', str(kwargs['checkpoint']) + ".pth")
    ...
    evaldir = evaldir + '_reg_loss_edit_diffuse_rgb_bodian'
