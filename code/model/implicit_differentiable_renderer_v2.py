...
class IDRNetwork(nn.Module):
    ...
    def forward(self, input):
        ...
        ### get the points edited, with a 3D -> 2D -> 3D mapping
        edited_points_list = ...
        ...
        if differentiable_surface_points.shape[0] > 0:
            ...
            ret = self.get_rbg_value(differentiable_surface_points, view_dirs, edited_points_list, diffuse_rgb)
    ...
    def get_rbg_value(self, points, view_dirs, edited_points_list=[], diffuse_rgb=None):
        ...
        points_0, points_1, idx = self.split_points(points, edited_points_list)
        diffuse_albedo_0 = self.diffuse_albedo_layers(points_0)
        diffuse_albedo_1 = self.diffuse_albedo_layers_finetuned(points_1)
        diffuse_albedo = self.merge_points(diffuse_albedo_0, diffuse_albedo_1, idx)
    ...
    def split_points(self, points, edited_points_list):
        # TODO: split points into edited ones and unedited ones according to the edited_points_list


        return points_0, points_1, idx


    def merge_points(self, diffuse_albedo_0, diffuse_albedo_1, idx):
        # TODO: merge diffuse_albedo_0 / 1 into diffuse_albedo according to the index
